...
function checkShareRcptMsg(jsonObj) {
    ...
    if (jsonObj.hasOwnProperty("Receipt") && jsonObj.hasOwnProperty("TXID") && jsonObj.hasOwnProperty("fingerprint")  && jsonObj.hasOwnProperty("_id")) {
        console.log("TEST")
        // check if "Receipt" is json, "TXID" is string and "Fingerprint" is string
        if (typeof jsonObj["Receipt"] === "object" && typeof jsonObj["TXID"] === "string" && typeof jsonObj["fingerprint"] === "string" && typeof jsonObj["_id"] === "string") {
